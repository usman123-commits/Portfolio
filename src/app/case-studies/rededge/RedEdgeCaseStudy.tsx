    ...
    <main className="min-h-screen">
      ...
      <section className="bg-[var(--surface-soft)] py-16 lg:py-24">
        <Container>
          ...
          >
            {/* Problem */}
            <div className="bg-white p-8 rounded-2xl border border-[var(--border)] hover:shadow-md transition-all duration-200 relative overflow-hidden">
            ...
            {/* Solution */}
            <div className="bg-white p-8 rounded-2xl border border-[var(--border)] hover:shadow-md transition-all duration-200 relative overflow-hidden" style={{ transitionDelay: '100ms' }}>
      ...
      <section className="bg-[var(--navy-950)] py-16">
        <Container>
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            {[
              { stat: '0', label: 'Paper forms used on-site' },
              { stat: '~2 min', label: 'Time to generate PDF report' },
              { stat: '100%', label: 'Jobs with complete photo records' },
            ].map(({ stat, label }) => (
              <div key={label}>
                <p
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              {[
                ...
                <div
                  key={stack.label}
                  className="bg-[var(--surface-soft)] border border-[var(--border)] rounded-2xl p-8 hover:shadow-md transition-all duration-200"
                >
